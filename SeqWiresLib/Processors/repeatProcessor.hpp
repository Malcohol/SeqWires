...
namespace seqwires {
    class RepeatProcessorInput : public babelwires::ParallelValueProcessorInputBase {
      public:
    ...
    class RepeatProcessorOutput : public babelwires::ParallelValueProcessorOutputBase {
      public:
    ...
    class RepeatProcessor : public babelwires::ParallelValueProcessor {
      public:
