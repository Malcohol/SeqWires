...
namespace smf {
    ...
    class SmfSourceFormat : public babelwires::SourceFileFormat {
      public:
        ...
        loadFromFile(babelwires::DataSource& dataSource, const ProjectContext& projectContext, babelwires::UserLogger& userLogger) const override;
    };
    ...
    class SmfFormat0TargetFormat : public babelwires::TargetFileFormat {
      public:
        ...
        virtual std::string getManufacturerName() const override;
        virtual std::string getProductName() const override;
        virtual std::unique_ptr<babelwires::FileFeature> createNewFeature(const ProjectContext& projectContext) const override;
