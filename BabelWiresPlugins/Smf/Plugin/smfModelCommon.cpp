...
smf::MidiMetadata::MidiMetadata() {
    m_specFeature = addField(std::make_unique<GmSpecTypeFeature>(), REGISTERED_ID("Spec", "MIDI Spec", "15a9fa85-f2c6-4e68-8691-fefd64ca1233"));
    m_tempo = addOptionalField(std::make_unique<seqwires::TempoFeature>(),
                       REGISTERED_ID(tempoMetadataId, "Tempo", "3ef804e9-e34a-4a25-b6bf-ce7597d9d90b"));
    m_sequenceName = addOptionalField(std::make_unique<babelwires::StringFeature>(),
                              REGISTERED_ID(nameMetadataId, "Name", "c2e4910f-d006-4a93-97a7-ae5973157ec8"));
    m_copyright = addOptionalField(std::make_unique<babelwires::StringFeature>(),
                           REGISTERED_ID(copyrightMetadataId, "Copyright", "a59dc914-d060-4f03-be83-5804fc4d6b6a"));
}
