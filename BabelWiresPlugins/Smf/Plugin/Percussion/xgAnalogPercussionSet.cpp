...
smf::XgAnalogPercussionSet::XgAnalogPercussionSet(const seqwires::BuiltInPercussionInstruments& builtInInstruments)
...
babelwires::LongIdentifier smf::XgAnalogPercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("XGAnalogPerc", "Yamaha XG Analog Percussion", "f172fe57-7ec0-43de-9031-3a4ebe3da84d");
}
