...
smf::XgClassicPercussionSet::XgClassicPercussionSet(
...
babelwires::LongIdentifier smf::XgClassicPercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("XGClassicPerc", "Yamaha XG Classic Percussion",
                             "f7c61e91-dee8-4244-83a6-8aa0c1506964");
}
