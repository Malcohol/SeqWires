...
smf::GM2OrchestraPercussionSet::GM2OrchestraPercussionSet(
    ...
    : PercussionSet(getThisIdentifier(), 1,
                    builtInInstruments.convertToIdentifiers({seqwires::BuiltInPercussionInstruments::Value::ClHH2,
...
babelwires::LongIdentifier smf::GM2OrchestraPercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("GM2OrchestraPerc", "General MIDI 2 Orchestra Percussion", "6a77f085-35c7-409c-92e1-5f4a20f3c750");
}
