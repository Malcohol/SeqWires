    ...
    : PercussionSetWithPitchMap(getThisIdentifier(), 1,
                    std::vector<InstrumentBlock>{
                        ...
                        {{seqwires::BuiltInPercussionInstruments::Value::Rain,
                          ...
                          REGISTERED_ID("XgFeed", "XG Feed", "68af6288-ccda-41f8-b651-d703f5fa56eb")},
                         68,
                         &builtInInstruments},
                        {{seqwires::BuiltInPercussionInstruments::Value::Dog,
                          ...
                          REGISTERED_ID("XgMaou", "XG Maou", "8545a36b-2dfc-4826-8873-76989550d7c7")},
                         84,
                         &builtInInstruments},
                    },
                    36) {}

babelwires::LongIdentifier smf::XgSFX1PercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("XGSFX1Perc", "Yamaha XG SFX 1 Percussion", "fb2f88a2-de91-418d-8b8c-26aaac97c1ba");
}
