...
smf::XgElectroPercussionSet::XgElectroPercussionSet(
...
babelwires::LongIdentifier smf::XgElectroPercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("XGElectroPerc", "Yamaha XG Electro Percussion",
                             "eb1c03a3-292c-4bc9-b932-ce1c989e02ca");
}
