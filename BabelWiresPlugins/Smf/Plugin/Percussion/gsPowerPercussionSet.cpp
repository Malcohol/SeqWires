...
smf::GsPowerPercussionSet::GsPowerPercussionSet(
...
babelwires::LongIdentifier smf::GsPowerPercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("GSPowerPerc", "Roland GS Power Percussion",
                             "75470199-d7ee-4648-b922-ca8a62b21f02");
}
