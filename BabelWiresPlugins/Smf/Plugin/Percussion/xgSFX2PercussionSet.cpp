...
babelwires::LongIdentifier smf::XgSFX2PercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("XGSFX2Perc", "Yamaha XG SFX 2 Percussion", "217785d3-ac7b-4a2f-9e7b-21e601cf0485");
}
