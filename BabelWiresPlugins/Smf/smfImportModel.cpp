...
std::unique_ptr<babelwires::Feature> smf::import::ChannelGroup::createNextEntry() const {
    return std::make_unique<ChannelTrackFeature>();
}

seqwires::TrackFeature* smf::import::ChannelGroup::addTrack(int c) {
...
const seqwires::TrackFeature* smf::import::ChannelGroup::getTrack(int c) const {
