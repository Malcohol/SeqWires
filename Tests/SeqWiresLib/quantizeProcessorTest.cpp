...
TEST(QuantizeProcessorTest, funcSimple) {
    ...
    testUtils::addNotes(
        {
            {60, seqwires::ModelDuration(1, 17), seqwires::ModelDuration(16, 17)},
...
TEST(QuantizeProcessorTest, funcCollapsedGroup) {
    ...
    testUtils::addNotes(
        {
            {60, seqwires::ModelDuration(1, 17), seqwires::ModelDuration(15, 17)},
            // This note shrinks to nothing and so should be removed.
            {62, seqwires::ModelDuration(0, 17), seqwires::ModelDuration(2, 17)},
            {64, seqwires::ModelDuration(0, 17), seqwires::ModelDuration(16, 17)},
            {65, seqwires::ModelDuration(0, 17), seqwires::ModelDuration(17, 17)},
        },
        trackIn);
