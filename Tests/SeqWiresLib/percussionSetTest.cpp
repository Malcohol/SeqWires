...
TEST(PercussionSetTest, oneInstrumentBlockAllNew) {
    // No need to supply a point to BuiltInPercussionInstruments in this case.
    seqwires::PercussionSet::InstrumentBlock block = {{testUtils::getTestRegisteredIdentifier("Bar"),
                                                       testUtils::getTestRegisteredIdentifier("Boo")},
                                                      50};

    seqwires::PercussionSet percussionSet(testUtils::getTestRegisteredLongIdentifier("Foo"), 12, block, 50);
...
TEST(PercussionSetTest, oneInstrumentBlockMixed) {
    testUtils::TestEnvironment testEnvironment;
    const seqwires::BuiltInPercussionInstruments* const builtIns =
        testEnvironment.m_typeSystem.addEntry(std::make_unique<seqwires::BuiltInPercussionInstruments>());
...
TEST(PercussionSetTest, twoInstrumentBlocks) {
    testUtils::TestEnvironment testEnvironment;
    const seqwires::BuiltInPercussionInstruments* const builtIns =
        testEnvironment.m_typeSystem.addEntry(std::make_unique<seqwires::BuiltInPercussionInstruments>());

    seqwires::PercussionSet::InstrumentBlock block0 = {{seqwires::BuiltInPercussionInstruments::Value::HBongo,
                                                       seqwires::BuiltInPercussionInstruments::Value::Claves,
                                                       seqwires::BuiltInPercussionInstruments::Value::Bass1},
                                                      40,
                                                      builtIns};

    seqwires::PercussionSet::InstrumentBlock block1 = {{testUtils::getTestRegisteredIdentifier("Bar"),
                                                       testUtils::getTestRegisteredIdentifier("Boo")},
                                                      50};

    seqwires::PercussionSet percussionSet(testUtils::getTestRegisteredLongIdentifier("Foo"), 12, { block0, block1 }, 41);
...
TEST(PercussionSetTest, duplicates) {
    testUtils::TestEnvironment testEnvironment;
    const seqwires::BuiltInPercussionInstruments* const builtIns =
        testEnvironment.m_typeSystem.addEntry(std::make_unique<seqwires::BuiltInPercussionInstruments>());
