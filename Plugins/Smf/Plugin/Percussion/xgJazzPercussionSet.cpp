...
smf::XgJazzPercussionSet::XgJazzPercussionSet(const bw_music::BuiltInPercussionInstruments& builtInInstruments)
    : PercussionSetWithPitchMap(InstrumentBlock{{bw_music::BuiltInPercussionInstruments::Value::MSurdo,
                                                 ...
                                                 bw_music::BuiltInPercussionInstruments::Value::LFlTom, // Jazz Tom 1
                                                 bw_music::BuiltInPercussionInstruments::Value::ClHHat,
                                                 bw_music::BuiltInPercussionInstruments::Value::HFlTom, // Jazz Tom 2
                                                 bw_music::BuiltInPercussionInstruments::Value::PdHHat,
                                                 bw_music::BuiltInPercussionInstruments::Value::LwTom, // Jazz Tom 3
                                                 bw_music::BuiltInPercussionInstruments::Value::OpHHat,
                                                 bw_music::BuiltInPercussionInstruments::Value::LMTom, // Jazz Tom 4
                                                 bw_music::BuiltInPercussionInstruments::Value::HMTom, // Jazz Tom 5
                                                 bw_music::BuiltInPercussionInstruments::Value::Crash1,
                                                 bw_music::BuiltInPercussionInstruments::Value::HTom, // Jazz Tom 6
