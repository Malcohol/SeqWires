...
smf::GM2RoomPercussionSet::GM2RoomPercussionSet(const bw_music::BuiltInPercussionInstruments& builtInInstruments)
    : PercussionSetWithPitchMap(InstrumentBlock{{bw_music::BuiltInPercussionInstruments::Value::HighQ,
                                                 ...
                                                 bw_music::BuiltInPercussionInstruments::Value::RLwTm2,
                                                 bw_music::BuiltInPercussionInstruments::Value::ClHHat,
                                                 bw_music::BuiltInPercussionInstruments::Value::RLwTm1,
                                                 bw_music::BuiltInPercussionInstruments::Value::PdHHat,
                                                 bw_music::BuiltInPercussionInstruments::Value::RMdTm2,
                                                 bw_music::BuiltInPercussionInstruments::Value::OpHHat,
                                                 bw_music::BuiltInPercussionInstruments::Value::RMdTm1,
                                                 bw_music::BuiltInPercussionInstruments::Value::RHiTm2,
                                                 bw_music::BuiltInPercussionInstruments::Value::Crash1,
                                                 bw_music::BuiltInPercussionInstruments::Value::RHiTm1,
