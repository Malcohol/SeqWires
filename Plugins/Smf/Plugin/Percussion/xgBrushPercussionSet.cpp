...
smf::XgBrushPercussionSet::XgBrushPercussionSet(const seqwires::BuiltInPercussionInstruments& builtInInstruments)
...
babelwires::LongIdentifier smf::XgBrushPercussionSet::getThisIdentifier() {
    return REGISTERED_LONGID("XGBrushPerc", "Yamaha XG BrushPercussion", "096bbcd8-5302-42e0-9ac9-560fd7a570f3");
}
