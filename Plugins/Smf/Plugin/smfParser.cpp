...
smf::SmfSequence::ConstInstance smf::SmfParser::getSmfSequenceConst() const {
    return SmfSequence::ConstInstance(m_result->getFeature(0)->is<babelwires::ValueTreeNode>());
}

smf::SmfSequence::Instance smf::SmfParser::getSmfSequence() {
    return SmfSequence::Instance(m_result->getFeature(0)->is<babelwires::ValueTreeNode>());
}
